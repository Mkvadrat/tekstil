...
function register_mysettings() {
	...
	register_setting( 'baw-settings-group', 'pn_address' );
	register_setting( 'baw-settings-group', 'pn_mark' );
	register_setting( 'baw-settings-group', 'pn_callback' );
	register_setting( 'baw-settings-group', 'pn_phone' );
	register_setting( 'baw-settings-group', 'pn_work' );
	register_setting( 'baw-settings-group', 'pn_logo' );
	register_setting( 'baw-settings-group', 'pn_phonefot' );
	register_setting( 'baw-settings-group', 'pn_coordinates' );
}
...
<form method="post" action="options.php">
    ...
    <table class="form-table">
        ...
        <td><textarea name="pn_address" rows="3" cols="150"><?php echo get_option('pn_address'); ?></textarea></td>
        </tr>
		<th scope="row">Заголовок 1:</th>
		<td><input type="text" name="pn_mark" value="<?php echo get_option('pn_mark'); ?>" size="152" /></td>
        </tr>
		<tr valign="top">
        <th scope="row">Обратный звонок:</th>
        <td><textarea name="pn_callback" rows="3" cols="150"><?php echo get_option('pn_callback'); ?></textarea></td>
        </tr>
		<tr valign="top">
		...
		<td><input type="text" name="pn_work" value="<?php echo get_option('pn_work'); ?>" size="152" /></td>
        </tr>
		<tr valign="top">
        <th scope="row">Информация компании разработчика:</th>
        <td><textarea name="pn_logo" rows="3" cols="150"><?php echo get_option('pn_logo'); ?></textarea></td>
        </tr>
		<tr valign="top">
        <th scope="row">Телефон и соц. сеть:</th>
        <td><textarea name="pn_phonefot" rows="3" cols="150"><?php echo get_option('pn_phonefot'); ?></textarea></td>
        </tr>
		<tr valign="top">
        <th scope="row">Координаты карты:</th>
        <td><input type="text" name="pn_coordinates" value="<?php echo get_option('pn_coordinates'); ?>" size="152" /></td>
        </tr>
